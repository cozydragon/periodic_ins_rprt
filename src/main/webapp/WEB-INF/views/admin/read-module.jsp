							...
							<form role="form-group" method="post">
								...
								<div class="row">
									...
									<div class="col-sm-3">
										<div class="form-group">
											<label>serial명</label>
											<input class="form-control" name="serial_name" id="serial_name" disabled="disabled" value="${ModuleDTO.serial_name}">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
	                                        <label>모듈종류</label>
											<select class="form-control" name="module_variety" id="module_variety" disabled="disabled" >
												<option value="">선택</option>
								...
								<div class="row">
									...
									<div class="col-sm-3">
										<div class="form-group">
											<label>상세내역</label>
											<input class="form-control" name="detail" id="detail" disabled="disabled" value="${ModuleDTO.detail}">
										</div>
									</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".clist").on("click",function(){
				...
				formObj.attr("action","/admin/show-module");
				formObj.submit();
			});
			...
			$(".cdelete").on("click",function(){
				...
				formObj.attr("action","/admin/delete-module");
				formObj.submit();
			});
