...
<div class="wrap">
		<%@ include file="/WEB-INF/views/include/headNavMenu.jsp" %>
	<div id="nav">
		<%@ include file="/WEB-INF/views/include/sidebarMenu.jsp" %>
    </div>
		...
		<div class="contain">
			<div class="content">
				...
				<div class="con">
					...
					<div class="tb_bt"><a href="/menu1001_1" class="btn red">등록</a></div>
				</div>
